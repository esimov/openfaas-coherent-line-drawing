...
//
func Sobel(src Mat, dst *Mat, dDepth int, dx int, dy int,
	kSize int, scale float64, delta float64, borderType BorderType) {
...
//
// For further details, please see:
// https://docs.opencv.org/3.3.1/d2/de8/group__core__array.html#ga1ba1026dca0807b27057ba6a49d258c0
